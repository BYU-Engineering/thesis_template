...
\begin{marginfigure}
	\includegraphics[width=1.8in]{figures/brachistochrone}
...
\begin{figure}[htbp]
	\begin{sidecaption}{This is a figure with a side caption that is not short, but not that long either.}[fig:sidecap]
		\centering
		\includegraphics[width=3.5in]{figures/gradf_half_space}
	\end{sidecaption}
\end{figure}
...
\begin{figure}
	...
	\begin{sidecaption}{The caption for a full-width figure appears in the margin below it.}[fig:fullwidth] %Such figures utilize the side margin.}
		\includegraphics[width=1.35\textwidth]{figures/altitude-pitch-all}
	\end{sidecaption}
